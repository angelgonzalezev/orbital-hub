            ...
            {founder.twitterHandle && (
              ...
              >
                <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-white/70 group-hover:text-white transition-colors">@{founder.twitterHandle}</span>
                </div>
                <span className="text-[10px] text-white/20 uppercase tracking-widest font-bold group-hover:text-primary-500 transition-colors">Twitter / X</span>
              </a>
            )}
            {founder.telegramHandle && (
              ...
              >
                <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-white/70 group-hover:text-white transition-colors">@{founder.telegramHandle}</span>
                </div>
                 <span className="text-[10px] text-white/20 uppercase tracking-widest font-bold group-hover:text-primary-500 transition-colors">Telegram</span>
              </a>
            )}
          </div>
        )}
